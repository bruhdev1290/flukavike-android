...
public final class DatabaseModule_ProvideChannelDaoFactory implements Factory<ChannelDao> {
  ...
  public DatabaseModule_ProvideChannelDaoFactory(Provider<AppDatabase> appDatabaseProvider) {
    this.appDatabaseProvider = appDatabaseProvider;
  }

  @Override
  public ChannelDao get() {
    return provideChannelDao(appDatabaseProvider.get());
  }

  public static DatabaseModule_ProvideChannelDaoFactory create(
      Provider<AppDatabase> appDatabaseProvider) {
    return new DatabaseModule_ProvideChannelDaoFactory(appDatabaseProvider);
  }

  public static ChannelDao provideChannelDao(AppDatabase appDatabase) {
    return Preconditions.checkNotNullFromProvides(DatabaseModule.INSTANCE.provideChannelDao(appDatabase));
  }
}
